...
SELECT 
    sd.skills,
    ROUND(MEDIAN(jpf.salary_year_avg), 0) AS median_salary, -- we use MEDIAN here, not AVG, because it is less affected by outliers
    -- we still have 1 decimal, because it's DOUBLE data type, not the integer!
...
To get more insides the final table can be send to AI
