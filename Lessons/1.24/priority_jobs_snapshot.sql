...
-- MERGE INTO (this one query replaces UPDATE, INSERT and DELETE queries)
...
SELECT 
    job_title_short,
    COUNT(*) AS job_count, -- INTERESTING, that DuckDB can't handle COUNT(0) - it always returns 0!!!
